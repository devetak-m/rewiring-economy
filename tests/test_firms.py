...
class TestFirms(unittest.TestCase):
    def test_firm(self):
        ...
        W = np.array(
            [[0, 0.2, 0, 0, 0.8], [1, 0, 0, 0, 0], [0, 0.5, 0, 0.3, 0.2], [0.6, 0.2, 0.2, 0, 0], [0.3, 0, 0, 0.7, 0]]
        )
        ...
        C = np.array(
            [-1.145027010664114, -1.552188110924564, -2.739288221175688, -0.180811957940223, -0.459074641411455]
        )
        ...
        lp = np.array(
            [-3.125690573095744, -2.837019797749766, -2.810549207631804, -1.319647897335476, -1.377873331412342]
        )
        ...
        g = np.array(
            [
                [0, 0.934302008268644, 0, 0, 2.238857348005475],
    ...
    def test_expectations(self):
        ...
        W = np.array(
            [[0, 0.8, 0, 0, 0.3], [1, 0, 0, 0, 0], [0, 0.5, 0, 0.3, 0.2], [0.6, 0.2, 0.2, 0, 0], [0.3, 0, 0, 0.7, 0]]
        )
        ...
        eW_tilde = np.array([[0, 0.448, 0, 0.09], [0.49, 0, 0, 0], [0.294, 0.112, 0, 0], [0.147, 0, 0.441, 0]])
        ...
        eW_prime = np.array([[0, 0.448, 0, 0.09], [0.49, 0, 0, 0], [0.294, 0.112, 0, 0], [0.147, 0, 0.441, 0]])
        ...
        ep_all = np.array(
            [0.056123125136911, 0.024696969123350, 0.060171936429203, 0.143386728042801, 0.156514643757050]
        )
        ...
        ex_all = np.array(
            [7.503545499223542, 16.453435449991755, 6.574085088406625, 2.724675215748445, 2.774154956103680]
        )
        ...
        eg = np.array(
            [
                [0, 3.243668164557984, 0, 0, 0.696283904825306],
